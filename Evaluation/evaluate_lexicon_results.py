...
if __name__ == "__main__":
    overview_rules([("./weights_csv/Bob_weights.csv", "P1_Eng"), ("./weights_csv/Etienne_weights.csv", "P2_Eng"), ("./weights_csv/Patty S1_weights.csv", "P3_Ger"),
                      ("./weights_csv/Katharina_weights.csv", "P4_Sn"), ("./weights_csv/Luisa_weights.csv", "P5_Esp"), ("./weights_csv/Valentin_weights.csv", "P6_Eng")]
                   , "results_learning_six_part.csv")
